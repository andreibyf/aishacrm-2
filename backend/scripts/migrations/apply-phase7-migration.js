...
async function main() {
  ...
  console.log(
    `   • ai_conversation_summaries: ${tableStatus.ai_conversation_summaries ? '✓' : '✗ MISSING'}`,
  );
  console.log('\n');
  ...
  const migrationPath = path.join(
    __dirname,
    'supabase/migrations/20241224120000_ai_memory_rag.sql',
  );
  ...
  console.log(
    '   3. Paste the contents of: backend/supabase/migrations/20241224120000_ai_memory_rag.sql',
  );
  console.log('   4. Click "Run"\n');

  console.log('Alternative: Use psql command-line tool:');
  console.log(
    '   psql "$DATABASE_URL" -f backend/supabase/migrations/20241224120000_ai_memory_rag.sql\n',
  );
