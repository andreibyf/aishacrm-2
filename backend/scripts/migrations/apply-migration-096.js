...
const statements = [
  {
    desc: 'Make leads.tenant_id_text nullable',
    sql: 'ALTER TABLE leads ALTER COLUMN tenant_id_text DROP NOT NULL',
  },
  {
    desc: 'Make accounts.tenant_id_text nullable',
    sql: 'ALTER TABLE accounts ALTER COLUMN tenant_id_text DROP NOT NULL',
  },
  {
    desc: 'Make contacts.tenant_id_text nullable',
    sql: 'ALTER TABLE contacts ALTER COLUMN tenant_id_text DROP NOT NULL',
  },
  {
    desc: 'Make opportunities.tenant_id_text nullable',
    sql: 'ALTER TABLE opportunities ALTER COLUMN tenant_id_text DROP NOT NULL',
  },
  {
    desc: 'Make activities.tenant_id_text nullable',
    sql: 'ALTER TABLE activities ALTER COLUMN tenant_id_text DROP NOT NULL',
  },
  {
    desc: 'Make note.tenant_id_text nullable',
    sql: 'ALTER TABLE note ALTER COLUMN tenant_id_text DROP NOT NULL',
  },
];
