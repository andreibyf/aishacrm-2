...
async function applyMigration() {
  try {
    ...
    console.log('');
    console.log(
      '⚠️  Note: You may need to apply this manually via Supabase Dashboard if RPC fails',
    );
    ...
    console.error(
      '2. Paste the contents of supabase/migrations/20251218_system_logs_nullable_tenant.sql',
    );
