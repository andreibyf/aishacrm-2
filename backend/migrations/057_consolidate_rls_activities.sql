...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname='public' 
      ...
      AND policyname='activities_all_consolidated_select'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname='public' 
      AND tablename='activities' 
      AND policyname='activities_all_consolidated_insert'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname='public' 
      AND tablename='activities' 
      AND policyname='activities_all_consolidated_update'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname='public' 
      AND tablename='activities' 
      AND policyname='activities_all_consolidated_delete'
  ) THEN
