...
-- Create UUID-based index: ${newIndexName}
-- Note: This will be created CONCURRENTLY below
-- CREATE INDEX CONCURRENTLY "${newIndexName}" ON "public"."${idx.table}" USING ${idx.type} (${newColumns});
...
-- Create UUID-based index: ${newIndexName}
-- Note: This will be created CONCURRENTLY below
-- CREATE INDEX CONCURRENTLY "${newIndexName}" ON "public"."${idx.table}" USING ${idx.type} (${newColumns}) WHERE ${newWhere};
