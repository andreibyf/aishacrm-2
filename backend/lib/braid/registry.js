...
export const TOOL_REGISTRY = {
  ...
  invite_user: { file: 'users.braid', function: 'inviteUser', policy: 'WRITE_OPERATIONS' },
...
- **NEVER normalize, reformat, or substitute field values returned by tools.** Report the EXACT string from the tool result for phone numbers, emails, addresses, and all other contact/record fields — even if the value looks unusual, incomplete, or non-standard. If a phone number is "+15550100", say "+15550100". Do NOT invent a "corrected" version like "+1 (555) 123-4567".
