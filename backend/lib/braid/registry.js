...
export const TOOL_REGISTRY = {
  ...
  // Communications
  process_inbound_communication: { file: 'communications.braid', function: 'processInboundCommunication', policy: 'WRITE_OPERATIONS' },
  ...
  clear_report_cache: { file: 'reports.braid', function: 'clearReportCache', policy: 'WRITE_OPERATIONS' },
