...
export const TOOL_DESCRIPTIONS = {
  ...
  trigger_workflow_by_name: 'Delegate a task to a named workflow. Use this when user wants to hand off work to an automated agent workflow. Pass workflow_name (e.g., "Sales Manager Workflow", "Customer Service Workflow"), context object with relevant data, and related_entity_type/id. The workflow will handle the task autonomously and log progress via notes.',
