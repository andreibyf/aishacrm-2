...
**Note:** For operational topics (backup/recovery, performance monitoring, maintenance tasks, troubleshooting), see the **[System Administrator Guide](./AISHA_CRM_ADMIN_GUIDE.md)** Chapters 8-11.
...
- TLS encryption in transit (enforced by Supabase)
