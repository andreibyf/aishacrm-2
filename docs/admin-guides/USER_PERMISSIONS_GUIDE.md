...
This guide covers the user permissions system, team assignments, and navigation controls in AishaCRM.
...
Toggle organization-wide permissions:

| Permission | Effect |
|------------|--------|
| **Notes Anywhere** | Can add notes to any record in the tenant |
| **All Records Access** | Full R/W access to all tenant records |
...
│  - See all records assigned to my team          │
│  - Edit only my own records                     │
│  - Add notes to team records                    │
└─────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────┐
│  Access Level: manage_team                      │
│  - See all records assigned to my team          │
│  - Edit any team record                         │
...
These permissions bypass team restrictions:
...
| Reports To (manager) | Permissions (perm_*) |
...
| Mode | Description |
|------|-------------|
| **Hierarchical** | Users see all records but write access is per-record |
| **Shared** | All team members have full R/W on all team records |
...
| User Type | Own Records | Team Records | Other Teams | Unassigned |
|-----------|-------------|--------------|-------------|------------|
| Member (view_own) | Full | Read+Notes | Read+Notes | Read+Notes |
| Member (view_team) | Full | Read+Notes | Read+Notes | Read+Notes |
| Manager (manage_team) | Full | Full | Read+Notes | Full |
| Director (multi-team) | Full | Full | Full | Full |
| perm_all_records | Full | Full | Full | Full |
| Admin/Superadmin | Full | Full | Full | Full |
