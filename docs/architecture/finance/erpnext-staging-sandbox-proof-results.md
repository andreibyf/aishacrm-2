...
- [ ] **Phase 3-2 migrations applied to staging.** 168 / 169 / 170 / 171 per [`staging-migration-application-log.md`](./staging-migration-application-log.md). Phase 3-10 needs `finance.adapter_jobs` (168), `finance.audit_events` (168 + 169 immutability triggers), and the RLS policies (171) all in place.
