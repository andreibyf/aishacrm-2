...
| [SELF_HOSTED_COMMUNICATIONS_TOPOLOGY.md](./SELF_HOSTED_COMMUNICATIONS_TOPOLOGY.md)                     | Communications runtime topology                        |
| [SELF_HOSTED_COMMUNICATIONS_COMPOSE_CONTRACT.md](./SELF_HOSTED_COMMUNICATIONS_COMPOSE_CONTRACT.md)     | Communications compose service contract                |
| [SELF_HOSTED_COMMUNICATIONS_INTERNAL_API.md](./SELF_HOSTED_COMMUNICATIONS_INTERNAL_API.md)             | Communications internal backend API                    |
| [SELF_HOSTED_COMMUNICATIONS_BRAID_TOOLS.md](./SELF_HOSTED_COMMUNICATIONS_BRAID_TOOLS.md)               | Communications Braid tool surface                      |
