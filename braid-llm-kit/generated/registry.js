 ...
 * Generated: 2025-12-22T01:28:43.915Z
...
export const TOOL_REGISTRY = {
  ...
  create_biz_dev_source: { file: 'bizdev-sources.braid', function: 'createBizDevSource', policy: 'WRITE_OPERATIONS' },
  update_biz_dev_source: { file: 'bizdev-sources.braid', function: 'updateBizDevSource', policy: 'WRITE_OPERATIONS' },
  get_biz_dev_source_details: { file: 'bizdev-sources.braid', function: 'getBizDevSourceDetails', policy: 'READ_ONLY' },
  list_biz_dev_sources: { file: 'bizdev-sources.braid', function: 'listBizDevSources', policy: 'READ_ONLY' },
  search_biz_dev_sources: { file: 'bizdev-sources.braid', function: 'searchBizDevSources', policy: 'READ_ONLY' },
  promote_biz_dev_source_to_lead: { file: 'bizdev-sources.braid', function: 'promoteBizDevSourceToLead', policy: 'READ_ONLY' },
  delete_biz_dev_source: { file: 'bizdev-sources.braid', function: 'deleteBizDevSource', policy: 'WRITE_OPERATIONS' },
  archive_biz_dev_sources: { file: 'bizdev-sources.braid', function: 'archiveBizDevSources', policy: 'READ_ONLY' },
  ...
  // navigation.braid
  navigate_to: { file: 'navigation.braid', function: 'navigateTo', policy: 'READ_ONLY' },
  ...
  // snapshot.braid
  fetch_snapshot: { file: 'snapshot.braid', function: 'fetchSnapshot', policy: 'READ_ONLY' },
  probe: { file: 'snapshot.braid', function: 'probe', policy: 'READ_ONLY' },
...
export const BRAID_PARAM_ORDER = {
  ...
  create_biz_dev_source: ['tenant', 'source_name', 'source_type', 'company_name', 'contact_name', 'email', 'phone', 'priority'],
  update_biz_dev_source: ['tenant', 'source_id', 'updates'],
  get_biz_dev_source_details: ['tenant', 'source_id'],
  list_biz_dev_sources: ['tenant', 'status', 'priority', 'limit'],
  search_biz_dev_sources: ['tenant', 'query', 'source_type', 'limit'],
  promote_biz_dev_source_to_lead: ['tenant', 'source_id', 'options'],
  delete_biz_dev_source: ['tenant', 'source_id'],
  archive_biz_dev_sources: ['tenant', 'source_ids'],
  ...
  navigate_to: ['tenant', 'page', 'record_id'],
  ...
  fetch_snapshot: ['tenant', 'scope', 'limit'],
...
export const TOOL_DESCRIPTIONS = {
  ...
  create_biz_dev_source: 'Create a new biz dev source record',
  update_biz_dev_source: 'Update an existing biz dev source record',
  get_biz_dev_source_details: 'Get details of a specific biz dev source details',
  list_biz_dev_sources: 'List biz dev sources records',
  search_biz_dev_sources: 'Search for biz dev sources records',
  promote_biz_dev_source_to_lead: 'promoteBizDevSourceToLead operation',
  delete_biz_dev_source: 'Delete a biz dev source record',
  archive_biz_dev_sources: 'archiveBizDevSources operation',
  ...
  navigate_to: 'navigateTo operation',
  ...
  fetch_snapshot: 'Fetch snapshot data',
