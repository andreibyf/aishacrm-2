...
export default function OpportunityKanbanCard({
  opportunity,
  accountName,
  assignedUserName,
  onEdit,
  ...
  return (
    ...
    >
      <Card
        className={`bg-slate-700 border-slate-600 transition-all cursor-grab active:cursor-grabbing ${isDragging ? 'shadow-2xl border-blue-500' : 'hover:border-blue-500'}`}
      >
        ...
        <CardContent className="p-3 pt-0 space-y-2">
          ...
          {assignedUserName && (
            <div className="text-xs text-slate-400 truncate">👤 {assignedUserName}</div>
          )}
