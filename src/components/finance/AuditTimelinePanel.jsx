    ...
    <div data-testid="finance-audit-timeline-panel">
      <Card className="border-slate-700/40 bg-slate-900/60 text-slate-100">
        <CardHeader className="flex flex-row items-start justify-between gap-3 pb-3">
          <div>
            <CardTitle className="text-base font-semibold text-slate-100">Audit timeline</CardTitle>
        ...
        <CardContent className="space-y-3">
          {state.error ? (
            ...
            <p className="text-xs text-slate-400" data-testid="finance-audit-timeline-loading">
              Loading…
            </p>
          ) : state.events.length === 0 ? (
            <p className="text-xs text-slate-400" data-testid="finance-audit-timeline-empty">
