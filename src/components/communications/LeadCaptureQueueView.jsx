        ...
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Unknown inbound senders awaiting review.
            </p>
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              <SelectTrigger id="lead-capture-status-filter">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          {loadingQueue ? (
            <div className="space-y-3">
              {[1, 2, 3].map((item) => (
                <div key={item} className="rounded-xl border bg-muted/50 p-4">
            ...
            <div className="rounded-xl border border-red-200 dark:border-red-900/50 bg-red-50 dark:bg-red-950/40 p-4 text-sm text-red-900 dark:text-red-200">
            ...
            <div className="rounded-xl border bg-muted/30 p-8 text-center">
              <CheckCircle2 className="mx-auto mb-3 h-8 w-8 text-emerald-500 dark:text-emerald-400" />
              <p className="text-sm font-medium">No queue items for this view.</p>
            </div>
          ) : (
            <div className="space-y-3">
              {queueItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full rounded-2xl border p-4 text-left transition ${
                      isSelected
                        ? 'border-cyan-400/60 bg-cyan-50 dark:bg-cyan-400/10 shadow-[0_0_0_1px_rgba(34,211,238,0.18)]'
                  ...
                  >
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      <Badge variant="outline">{summarizeQueueReason(item.reason)}</Badge>
                      {item.sender_domain ? (
                        <Badge variant="outline">{item.sender_domain}</Badge>
                      ) : null}
                    </div>
        ...
        <CardContent className="space-y-5">
          {loadingDetail ? (
            <div className="space-y-4">
              {[1, 2, 3].map((item) => (
                <div key={item} className="rounded-2xl border bg-muted/50 p-5">
            ...
            <>
              <div className="rounded-2xl border bg-muted/30 p-5">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <Badge
                    variant="outline"
                    className="border-cyan-500/50 text-cyan-700 dark:text-cyan-300"
                  >
                  ...
                  {selectedQueueItem.metadata?.promotion?.entity_id ? (
                    ...
                    >
                      <Badge
                        variant="outline"
                        className="cursor-pointer border-emerald-500/50 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-500/10"
                      >
              ...
              <div className="rounded-2xl border bg-muted/30 p-5">
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-[160px,1fr]">
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger id="lead-capture-status">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button
                  ...
                  disabled={actionSubmitting}
                  className="border-amber-500/50 text-amber-700 dark:text-amber-300 hover:bg-amber-50 dark:hover:bg-amber-500/10"
                >
                ...
                <Button
                  ...
                  disabled={actionSubmitting}
                  className="bg-cyan-600 text-white hover:bg-cyan-500 dark:bg-cyan-500 dark:text-slate-950 dark:hover:bg-cyan-400"
                >
