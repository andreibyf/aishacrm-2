      ...
      >
        ...
        <CardContent className="p-4 overflow-y-auto flex-1">
          <dl className="space-y-1">
            ...
            {(currentRecord.created_date || currentRecord.created_at) && (
              <DetailRow
                label="Created"
                value={formatDate(currentRecord.created_date || currentRecord.created_at)}
              />
            )}
            {/* leads/contacts/accounts/opportunities only have updated_at; */}
            {/* activities has both. Prefer the canonical column, fall back to legacy. */}
            {(currentRecord.updated_at || currentRecord.updated_date) && (
              <DetailRow
                label="Updated"
                value={formatDate(currentRecord.updated_at || currentRecord.updated_date)}
              />
            )}
          </dl>
        </CardContent>
