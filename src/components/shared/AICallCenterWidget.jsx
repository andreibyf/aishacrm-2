...
export default function AICallCenterWidget({
  ...
  const handleStartCall = async () => {
    ...
    const tenantIdForCall = user?.role === "superadmin"
      ? selectedTenantId
      : user?.tenant_id;

    if (!tenantIdForCall) {
      toast.error(
        "Could not determine the tenant for this call. Please select a tenant if you are an administrator.",
      );
      return;
    }
          ...
          >
            ...
            <div className="flex justify-between items-center pb-2 border-b border-white/30 mb-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-semibold">AI Call Center</h2>{" "}
                {/* Replaced CardTitle */}
              </div>
              <Button
                variant="ghost"
            ...
            <p className="text-blue-100 mb-4">Initiate an AI-powered call.</p>
            {" "}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <Label htmlFor="callObjective" className="text-white">
                  Call Objective *
                </Label>
                <Textarea
                  id="callObjective"
                  ...
                  placeholder="e.g., Follow up on quote, schedule demo"
                  required
                  className="bg-white/10 border-white/30 text-white placeholder-white/70"
                />
              </div>
