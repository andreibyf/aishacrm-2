          ...
          <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="webhooks">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-slate-600">
                    Webhooks can be configured in <Badge variant="outline">Settings → Webhooks</Badge> to send real-time data to external services like Zapier or n8n when events occur in the CRM (e.g., a new contact is created).
                  </p>
