            ...
            <div className="space-y-3">
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  ...
                  <p><strong>References:</strong> account_id → Account, assigned_to → Employee</p>
              ...
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  ...
                  <p><strong>References:</strong> converted_contact_id → Contact, account_id → Account</p>
              ...
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  ...
                  <p><strong>References:</strong> account_id → Account, contact_id → Contact</p>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-4 text-sm text-slate-700">
            <div className="bg-white p-4 rounded-lg border border-slate-200">
              ...
              <p className="text-slate-600 mb-2"><strong>Current:</strong> Contact.account_id → Account.id (string reference, no validation)</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              ...
              <ul className="space-y-1 text-sm text-slate-700">
                <li>• Dashboard load: <strong>3s → 0.5s</strong> (83% faster)</li>
                <li>• List views: <strong>2s → 0.8s</strong> (60% faster)</li>
                <li>• Form loads: <strong>1.5s → 0.3s</strong> (80% faster)</li>
                <li>• Reports: <strong>10s → 1s</strong> (90% faster)</li>
              </ul>
            </div>
