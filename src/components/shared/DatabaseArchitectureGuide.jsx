...
import { Archive, Database, GitBranch, Shield, TrendingUp, Zap } from 'lucide-react';
        ...
        <CardContent className="space-y-4">
          <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
            ...
            <ul className="space-y-2 text-sm text-slate-700">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Flat Entity Model:</strong> Each entity (Contact, Account, Lead, etc.) is
                  independent with loose relationships via ID references
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-orange-500 mt-1">●</span>
                <span>
                  <strong>No Referential Integrity:</strong> Legacy NoSQL databases don&apos;t
                  enforce foreign key constraints automatically
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-orange-500 mt-1">●</span>
                <span>
                  <strong>Mixed Normalization:</strong> Some denormalization (caching names/emails)
                  but inconsistent
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-orange-500 mt-1">●</span>
                <span>
                  <strong>Single Tenant Filtering:</strong> All queries filter by tenant_id at
                  application level
                </span>
              </li>
            </ul>
          ...
          <Alert className="bg-amber-50 border-amber-200">
            <AlertDescription className="text-slate-700">
              <strong>Key Issues:</strong> Orphaned records, expensive JOIN-like operations, no
              historical tracking, slow aggregate queries
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-6">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <p className="text-sm text-slate-700 mb-3">
              Combines traditional star schema patterns (fact tables + dimension tables) with
              MongoDB&apos;s document flexibility. Core business entities become &quot;fact
              tables&quot; while reference data becomes &quot;dimension tables.&quot;
            </p>
            <div className="text-sm text-slate-700">
              <strong>Benefits:</strong> Faster queries, better data integrity, easier analytics,
            ...
            <div className="space-y-3">
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  <p>
                    <strong>Purpose:</strong> Store all contact interactions and attributes
                  </p>
                  <p>
                    <strong>Key Fields:</strong> id, tenant_id, unique_id, first_name, last_name,
                    email, phone
                  </p>
                  <p>
                    <strong>References:</strong> account_id → Account, assigned_to → Employee
                  </p>
                  <p>
                    <strong>Optimization:</strong> Index on [tenant_id, status, assigned_to,
                    created_date]
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  <p>
                    <strong>Purpose:</strong> Track sales pipeline and conversion funnel
                  </p>
                  <p>
                    <strong>Key Fields:</strong> id, tenant_id, unique_id, status, score, source
                  </p>
                  <p>
                    <strong>References:</strong> converted_contact_id → Contact, account_id →
                    Account
                  </p>
                  <p>
                    <strong>Optimization:</strong> Index on [tenant_id, status, score, created_date]
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  ...
                  <p>
                    <strong>Key Fields:</strong> id, tenant_id, amount, stage, probability,
                    close_date
                  </p>
                  <p>
                    <strong>References:</strong> account_id → Account, contact_id → Contact
                  </p>
                  <p>
                    <strong>Optimization:</strong> Index on [tenant_id, stage, close_date, amount]
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  ...
                  <p>
                    <strong>Key Fields:</strong> id, tenant_id, type, due_date, status, related_to,
                    related_id
                  </p>
                  <p>
                    <strong>Optimization:</strong> Index on [tenant_id, due_date, status,
            ...
            <div className="space-y-3">
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  ...
                  <p>
                    <strong>Key Fields:</strong> id, tenant_id, unique_id, name, industry, type
                  </p>
                  <p>
                    <strong>Optimization:</strong> Index on [tenant_id, name], unique constraint on
                    [tenant_id, unique_id]
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  <p>
                    <strong>Purpose:</strong> User assignment and ownership tracking
                  </p>
                  <p>
                    <strong>Key Fields:</strong> id, tenant_id, email, user_email, first_name,
                    last_name
                  </p>
                  <p>
                    <strong>Optimization:</strong> Index on [tenant_id, email], [tenant_id,
                    is_active]
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  <p>
                    <strong>Purpose:</strong> Multi-tenant isolation and branding
                  </p>
                  <p>
                    <strong>Key Fields:</strong> id, name, domain, branding_settings
                  </p>
                  <p>
                    <strong>Optimization:</strong> Small table, full cache acceptable
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  ...
                  <p>
                    <strong>Pattern:</strong> Polymorphic relationship via related_to + related_id
                  </p>
                  <p>
                    <strong>Optimization:</strong> Composite index on [tenant_id, related_to,
                    related_id, created_date]
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  ...
                  <p>
                    <strong>Optimization:</strong> Index on [user_email, is_read, created_date],
              ...
              <div className="bg-white p-4 rounded-lg border border-slate-200">
                ...
                <div className="text-sm text-slate-600 space-y-1">
                  ...
                  <p>
                    <strong>Pattern:</strong> Write-heavy, read-light (admin only)
                  </p>
                  <p>
                    <strong>Optimization:</strong> Partition by date, archive quarterly, index on
                    [user_email, action_type, created_date]
                  </p>
                </div>
              </div>
            </div>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-4">
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Create validation functions to check foreign key relationships before writes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>
                    Add cascade delete handlers (e.g., deleting Account should handle related
                    Contacts)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
                  <span>Add data consistency checks in Settings → Utilities</span>
                </li>
              </ul>
              <div className="mt-3 text-sm text-slate-600">
                <strong>Timeline:</strong> 1 week | <strong>Impact:</strong> High - prevents data
                corruption
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Add cached fields to fact tables: account_name, assigned_to_name, contact_name
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-1">✓</span>
                  <span>
                    Create update triggers to maintain cached values when dimensions change
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-1">✓</span>
                  <span>
                    Add computed fields: contact_age_days, opportunity_age_days, activity_overdue
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-1">✓</span>
              ...
              <div className="mt-3 text-sm text-slate-600">
                <strong>Timeline:</strong> 2 weeks | <strong>Impact:</strong> Medium - 40% faster
                list views
              </div>
            </div>
            ...
            <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Create DailyStat entity: tenant_id, date, entity_type, metric_type, value
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-600 mt-1">✓</span>
                  <span>
                    Pre-compute dashboard metrics nightly (contact count, lead count, revenue)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-600 mt-1">✓</span>
              ...
              <div className="mt-3 text-sm text-slate-600">
                <strong>Timeline:</strong> 2 weeks | <strong>Impact:</strong> High - 90% faster
                dashboard/reports
              </div>
            </div>
            ...
            <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Create archive entities: ArchivedActivity, ArchivedOpportunity, ArchivedLead
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-600 mt-1">✓</span>
              ...
              <div className="mt-3 text-sm text-slate-600">
                <strong>Timeline:</strong> 1 week | <strong>Impact:</strong> High - reduces main
                table size by 60%
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-300">
              ...
              <div className="mt-3 text-sm text-slate-600">
                <strong>Timeline:</strong> 2 weeks | <strong>Impact:</strong> Medium - 30% overall
                performance boost
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 text-sm text-slate-700">
            <div className="bg-white p-4 rounded-lg border border-slate-200">
              ...
              <p className="text-slate-600 mb-2">
                <strong>Current:</strong> Contact.account_id → Account.id (string reference, no
                validation)
              </p>
              <p className="text-slate-600 mb-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2 text-slate-600">
                ...
                <li>
                  Add cascade option: when Account deleted, set contacts to account_id=null or
            ...
            <div className="bg-white p-4 rounded-lg border border-slate-200">
              ...
              <p className="text-slate-600 mb-2">
                <strong>Current:</strong> Activity.related_to + Activity.related_id (polymorphic
                pattern)
              </p>
              <p className="text-slate-600 mb-2">
                <strong>Proposed:</strong>
            ...
            <div className="bg-white p-4 rounded-lg border border-slate-200">
              ...
              <p className="text-slate-600 mb-2">
                <strong>Current:</strong> Contact/Lead.assigned_to (email string, inconsistent with
            ...
            <div className="bg-white p-4 rounded-lg border border-slate-200">
              ...
              <p className="text-slate-600 mb-2">
                <strong>Current:</strong> Real-time count queries on every dashboard load (slow for
                large datasets)
              </p>
              <p className="text-slate-600 mb-2">
                <strong>Proposed:</strong>
              ...
              <ul className="list-disc list-inside space-y-1 ml-2 text-slate-600">
                ...
                <li>
                  Run nightly cron job to calculate: total contacts, active leads, pipeline value,
                  etc.
                </li>
                <li>
                  Dashboard reads from cache (instant load) with &quot;as of date&quot; timestamp
                </li>
      ...
      <Card className="border-slate-200">
        ...
        <CardContent className="space-y-4">
          <Alert className="bg-blue-50 border-blue-200">
            <AlertDescription className="text-slate-700">
              <strong>Zero-Downtime Approach:</strong> All changes will be backward-compatible. No
              data loss risk.
            </AlertDescription>
          </Alert>
          ...
          <div className="space-y-3 text-sm text-slate-700">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Add cached fields like account_name, assigned_to_name to existing entities. Old
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Run utility to populate new fields for existing records. Can be done in batches
                  during off-hours.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Modify forms/lists to read from cached fields instead of lookups. Performance
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Implement referential integrity checks in create/update functions. Prevents future
                  orphans.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Set up archive tables and migration logic. Move old data gradually over 30 days.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">
                  Track query performance, adjust indexes, fine-tune cache TTLs based on real usage
                  patterns.
                </p>
              </div>
            </div>
      ...
      <Card className="border-green-200 bg-green-50">
        ...
        <CardContent className="space-y-3 text-slate-700">
          ...
          <Alert className="bg-white border-green-300 mt-4">
            <AlertDescription className="text-slate-700">
              <strong>Estimated Total Timeline:</strong> 8-10 weeks for full implementation across
              all phases
            </AlertDescription>
          </Alert>
        </CardContent>
...
// See DATABASE_OPTIMIZATION_SUMMARY in DatabaseArchitectureGuide.summary.js for reference data.
