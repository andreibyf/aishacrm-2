...
const ENTITY_PATTERNS = [
  ...
  { pattern: /^\/bizdev-sources/, entity: 'bizdev-sources', label: 'Potential Leads' },
...
export default function AiShaActionHandler() {
  ...
  useEffect(() => {
    ...
    const isListView =
      entityType !== 'general' &&
      !recordId &&
      !['dashboard', 'settings', 'reports'].includes(entityType);
    ...
    window.dispatchEvent(
      new CustomEvent('aisha:page-context-updated', {
        detail: context,
      }),
    );
      ...
      switch (action.action) {
        case 'navigate': {
          ...
          if (action.record_id && action.page) {
            ...
            setTimeout(() => {
              console.log('[AiSHA Action Handler] Dispatching aisha:open-details:', {
                id: action.record_id,
                type: action.page,
              });
              window.dispatchEvent(
                new CustomEvent('aisha:open-details', {
                  detail: {
                    id: action.record_id,
                    type: action.page,
                  },
        ...
        case 'edit_record': {
          ...
          window.dispatchEvent(
            new CustomEvent('aisha:open-edit', {
              detail: {
                id: action.record_id,
        ...
        case 'select_row': {
          ...
          window.dispatchEvent(
            new CustomEvent('aisha:select-row', {
        ...
        case 'open_form': {
          ...
          window.dispatchEvent(
            new CustomEvent('aisha:open-form', {
              detail: {
                type: action.entity_type,
