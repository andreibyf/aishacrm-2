    ...
    try {
      ...
      setResult({
        ...
        message: response.data.message ||
          `Denormalization sync (${syncMode}) completed successfully! Total records: ${
            response.data.totalSynced || 0
          }`,
      });
    } catch (error) {
    ...
    <div className="space-y-6">
      <Alert className="bg-blue-900/30 border-blue-700/50">
        ...
        <AlertDescription className="text-blue-300">
          Keep cached data fields synchronized across entities for optimal
          performance.
        </AlertDescription>
      </Alert>
