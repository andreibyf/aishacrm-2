...
const StatusBadge = ({ status }) => {
  ...
  return (
    <Badge
      ...
      className={isSet ? 'bg-green-100 text-green-800' : ''}
    >
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between items-center">
                  ...
                  <StatusBadge
                    status={results.current_env_status?.CLOUDFLARE_ACCOUNT_ID || 'MISSING'}
                  />
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <StatusBadge
                    status={results.current_env_status?.R2_SECRET_ACCESS_KEY || 'MISSING'}
                  />
                </div>
              </div>
            </div>
            ...
            {results.current_env_status?.CLOUDFLARE_ACCOUNT_ID === 'MISSING' && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  ...
                  <br />
                  Please add the missing environment variables in your hosting dashboard environment
                  variables.
                  <br />
