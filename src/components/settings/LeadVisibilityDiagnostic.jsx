          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="bg-slate-700/50 p-3 rounded">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <span className={`${result.lead_info.tenant_id === 'NOT SET ❌' ? 'text-red-400 font-bold' : 'text-slate-200'} font-mono text-xs`}>
            ...
            <div className="bg-slate-700/50 p-3 rounded">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <span className="text-slate-400">Tenant ID:</span>
                <span className={`${result.target_user_info.tenant_id === 'NOT SET ❌' ? 'text-red-400 font-bold' : 'text-slate-200'} font-mono text-xs`}>
            ...
            <Alert className={result.can_see_lead ? "bg-green-900/20 border-green-700" : "bg-red-900/20 border-red-700"}>
              ...
              <AlertDescription className={result.can_see_lead ? "text-green-300" : "text-red-300"}>
                <div className="font-semibold mb-2">
                  {result.can_see_lead ? "✅ User CAN see this lead" : "❌ User CANNOT see this lead"}
                </div>
