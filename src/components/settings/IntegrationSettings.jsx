            ...
            <div>
              ...
              <div className="bg-blue-900/20 p-4 rounded border border-blue-700/50">
                ...
                <ol className="list-decimal list-inside text-sm text-blue-200 space-y-3">
                  <li className="text-sky-600">Navigate to <strong>Settings → System → API Keys</strong>.</li>
                  ...
                  <li className="text-sky-600">Set the <strong>Webhook URL</strong> to the following, replacing `{'{tenant_id}'}` with your client's actual Tenant ID (found in Settings → Tenants):
