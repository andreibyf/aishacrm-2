...
export default function SystemAnnouncements() {
  ...
  return (
    <div className="space-y-6">
      <Card className="shadow-lg bg-slate-800 border-slate-700">
        <CardHeader>
          ...
          <CardDescription className="text-slate-400">
            Create and manage global or tenant-specific announcements.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button
          ...
          {showForm && (
            <form
              ...
              className="mt-6 space-y-4 p-4 border rounded-lg bg-slate-700/50 border-slate-600"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    value={
                      editingAnnouncement?.target_tenant_id || newAnnouncement.target_tenant_id
                    }
                    onValueChange={(value) => handleInputChange('target_tenant_id', value)}
                  >
                    <SelectTrigger className="bg-slate-700 border-slate-600 text-slate-200">
                      <SelectValue />
                    </SelectTrigger>
      ...
      <Card className="shadow-lg bg-slate-800 border-slate-700">
        <CardHeader>
          <CardTitle className="text-slate-100">Existing Announcements</CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (
                  ...
                  return (
                    <TableRow key={ann.id} className="border-slate-700">
                      ...
                      <TableCell className="text-slate-200">
                        {ann.target_tenant_id === 'all'
                          ? 'All Tenants'
                          : tenants.find((t) => t.id === ann.target_tenant_id)?.name || 'N/A'}
                      </TableCell>
