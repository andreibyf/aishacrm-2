...
export const AuditLogSchema = {
  ...
  properties: {
    ...
    user_role: {
      type: 'string',
      enum: ['admin', 'user'],
      description: 'Platform role of user at time of action (admin or user)',
    },
    user_display_role: {
      type: 'string',
      enum: ['superadmin', 'admin', 'power-user', 'user'],
  ...
  required: ['user_email', 'user_role', 'action_type', 'description'],
  rls: {
    read: {
      user_condition: {
        role: 'admin',
