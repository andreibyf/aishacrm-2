...
export const BizDevSourceSchema = {
  ...
  properties: {
    ...
    source: {
      type: 'string',
      description:
        "The origin of the business development data (e.g., 'Construction Directory Q4 2025')",
    },
    batch_id: {
      type: 'string',
    ...
    license_status: {
      type: 'string',
      enum: ['Active', 'Suspended', 'Revoked', 'Expired', 'Unknown', 'Not Required'],
    ...
    tags: {
      type: 'array',
      items: { type: 'string' },
      description: 'Tags/labels for categorizing this business development source',
    },
  },
