...
// [2026-02-23 Claude] — AiCampaigns overhaul: aligned with DB schema, expanded campaign types
export default function AICampaigns() {
  ...
  const loadCampaigns = useCallback(async () => {
    ...
    try {
      ...
      const paginatedCampaigns = displayCampaigns.slice(
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-lg">
        ...
        {/* Campaigns Table */}
        <Card className="shadow-lg border-slate-700 bg-slate-800 text-slate-300 rounded-t-none">
          {' '}
          {/* Added rounded-t-none for visual continuity */}
          <CardHeader>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-slate-800/50 border-slate-700 hover:bg-slate-700/50">
                        ...
                        <TableHead className="hidden md:table-cell text-slate-300">Type</TableHead>
                        <TableHead className="hidden lg:table-cell text-slate-300">
                          Contacts
                        </TableHead>
                        <TableHead className="hidden lg:table-cell text-slate-300">
                          Progress
                      ...
                      {campaigns.map((campaign) => (
                        ...
                        >
                          ...
                          >
                            <Badge
                              variant="outline"
                              className={`${statusColors[campaign.status]} border-none capitalize`}
                            >
                              {campaign.status}
                            </Badge>
                          </TableCell>
                              ...
                              >
                                ...
                                {campaign.status === 'running' ? (
                                  ...
                                  <DropdownMenuItem
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      handleStatusChange(campaign, 'running');
                                    }}
                                    className="focus:bg-slate-700"
                                  >
