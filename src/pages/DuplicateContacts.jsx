      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">
            Review and manage potential duplicate contact records
          </p>
        </div>
        <Button
          ...
          <>
            <Alert className="bg-orange-900/20 border-orange-700/50 text-orange-300">
              ...
              <AlertDescription>
                ...
                of potential duplicate contacts. Review each group and delete
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-semibold text-slate-200">
                              {group.primary.first_name}{" "}
                              {group.primary.last_name}
                            </span>
                          </div>
                          <div className="text-sm text-slate-400 space-y-1">
                            {group.primary.email && (
                              <div>📧 {group.primary.email}</div>
                            )}
                            {group.primary.phone && (
                              <div>📞 {group.primary.phone}</div>
                            )}
                            {group.primary.job_title && (
                              <div>💼 {group.primary.job_title}</div>
                            )}
                            <div className="text-xs text-slate-500">
                              Created:{" "}
                              {new Date(group.primary.created_date)
                                .toLocaleDateString()}
                            </div>
                          </div>
                        </div>
                      ...
                      {group.duplicates.map((duplicate) => (
                        <div
                          key={duplicate.id}
                          className="flex items-center justify-between p-4 rounded-lg bg-red-900/10 border border-red-700/30"
                        >
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              <Badge
                            ...
                            <div className="text-sm text-slate-400 space-y-1">
                              ...
                              {duplicate.phone && (
                                <div>📞 {duplicate.phone}</div>
                              )}
                              {duplicate.job_title && (
                                <div>💼 {duplicate.job_title}</div>
                              )}
                              <div className="text-xs text-slate-500">
                                Created:{" "}
                                {new Date(duplicate.created_date)
                                  .toLocaleDateString()}
                              </div>
                            </div>
                          </div>
