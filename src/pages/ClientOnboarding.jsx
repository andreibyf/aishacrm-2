...
import { Building2, Calendar, CheckCircle2, Loader2 } from "lucide-react";
...
const moduleOptions = [
  {
    id: "dashboard",
    label: "Dashboard",
    description: "Central analytics hub",
    default: true,
  },
  {
    id: "contacts",
  ...
  },
  {
    ...
    description: "Import business directories",
    default: false,
  },
  {
    id: "cash_flow",
  ...
  },
  {
    id: "ai_campaigns",
    label: "AI Campaigns",
    description: "AI-powered outreach",
    default: false,
  },
  {
    id: "utilities",
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent className="bg-slate-800 border-slate-700 max-h-[300px]">
                        <SelectItem value="accounting_and_finance">
                          Accounting & Finance
                        </SelectItem>
                        <SelectItem value="aerospace_and_defense">
                          Aerospace & Defense
                        </SelectItem>
                        <SelectItem value="agriculture_and_farming">
                          Agriculture & Farming
                        </SelectItem>
                        ...
                        <SelectItem value="chemicals_and_materials">
                          Chemicals & Materials
                        </SelectItem>
                        ...
                        <SelectItem value="consumer_goods_and_retail">
                        ...
                        <SelectItem value="energy_oil_and_gas">
                          Energy, Oil & Gas
                        </SelectItem>
                        <SelectItem value="entertainment_and_media">
                          Entertainment & Media
                        </SelectItem>
                        <SelectItem value="environmental_services">
                          Environmental Services
                        </SelectItem>
                        <SelectItem value="event_management">
                          Event Management
                        </SelectItem>
                        <SelectItem value="fashion_and_apparel">
                          Fashion & Apparel
                        </SelectItem>
                        ...
                        <SelectItem value="gaming_and_esports">
                          Gaming & Esports
                        </SelectItem>
                        <SelectItem value="government_and_public_sector">
                          Government & Public Sector
                        </SelectItem>
                        <SelectItem value="green_energy_and_solar">
                          Green Energy & Solar
                        </SelectItem>
                        <SelectItem value="healthcare_and_medical_services">
                          Healthcare & Medical Services
                        </SelectItem>
                        <SelectItem value="hospitality_and_tourism">
                          Hospitality & Tourism
                        </SelectItem>
                        ...
                        <SelectItem value="mining_and_metals">
                          Mining & Metals
                        </SelectItem>
                        <SelectItem value="nonprofit_and_ngos">
                          Nonprofit & NGOs
                        </SelectItem>
                        <SelectItem value="packaging_and_printing">
                          Packaging & Printing
                        </SelectItem>
                        ...
                        <SelectItem value="robotics_and_automation">
                          Robotics & Automation
                        </SelectItem>
                        <SelectItem value="saas_and_cloud_services">
                          SaaS & Cloud Services
                        </SelectItem>
                        <SelectItem value="security_services">
                          Security Services
                        </SelectItem>
                        ...
                        <SelectItem value="textiles_and_apparel">
                          Textiles & Apparel
                        </SelectItem>
                        ...
                        <SelectItem value="veterinary_services">
                          Veterinary Services
                        </SelectItem>
                        <SelectItem value="warehousing_and_distribution">
                          Warehousing & Distribution
                        </SelectItem>
                        <SelectItem value="wealth_management">
                          Wealth Management
                        </SelectItem>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(v) => updateField("business_model", v)}
                      >
                        <SelectTrigger className="bg-slate-700 border-slate-600 text-slate-100">
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(v) =>
                          updateField("geographic_focus", v)}
                      >
                        <SelectTrigger className="bg-slate-700 border-slate-600 text-slate-100">
                          <SelectValue />
                        </SelectTrigger>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateField("target_test_date", e.target.value)}
                        className="bg-slate-700 border-slate-600 text-slate-100"
                      />
                    </div>
                    <div>
                ...
                <div className="space-y-3">
                  <Alert className="bg-blue-900/30 border-blue-700/50">
                    <AlertDescription className="text-blue-300">
                      Select the modules you need. You can always add more
                      later.
                    </AlertDescription>
                  </Alert>
                ...
                <>
                  <Alert className="bg-amber-900/30 border-amber-700/50">
                    <AlertDescription className="text-amber-300">
                      This person will be the primary admin and receive the
                      invitation email.
                    </AlertDescription>
                  </Alert>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateEmployeeField("first_name", e.target.value)}
                        placeholder="John"
                        className="bg-slate-700 border-slate-600 text-slate-100"
                        required
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateEmployeeField("last_name", e.target.value)}
                        placeholder="Doe"
                        className="bg-slate-700 border-slate-600 text-slate-100"
                        required
                      />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateEmployeeField("email", e.target.value)}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateEmployeeField("phone", e.target.value)}
              ...
              {step < 4
                ? (
                  <Button
                    ...
                    disabled={step === 1 &&
                        (!formData.company_name || !formData.industry) ||
                      step === 4 &&
                        (!formData.initial_employee.first_name ||
                          !formData.initial_employee.last_name ||
                          !formData.initial_employee.email)}
                  >
                    Next
                  </Button>
                )
