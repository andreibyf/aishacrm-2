...
Deno.serve(async (req) => {
  try {
    ...
    const existing = await base44.asServiceRole.entities.DocumentationFile.filter({
      category: 'user_guide'
    });
    ...
    if (existing && existing.length > 0) {
      return Response.json({
        success: true,
        message: 'Documentation already exists. No new records created.',
        count: existing.length
      });
    }

    // This content should match the documentationSections from pages/Documentation
    const documentationContent = [
      {
        title: "Overview",
        description: "Welcome to Ai-SHA CRM and getting started guide",
        category: "user_guide",
        tags: ["getting-started", "overview", "welcome"],
        extracted_content: `
...
5. **Review reports** to gain insights into your business
      ...
      },
      {
        ...
        category: "user_guide",
        tags: ["contacts", "customers", "people"],
        extracted_content: `
# Contact Management
...
✓ **Regular cleanup** - mark inactive contacts
      ...
      },
      {
        ...
        category: "user_guide",
        tags: ["accounts", "companies", "organizations"],
        extracted_content: `
# Account Management
...
✓ **Use custom tags** for segmentation
      ...
      },
      {
        ...
        category: "user_guide",
        tags: ["leads", "prospects", "qualification"],
        extracted_content: `
# Lead Management
...
✓ **Convert when ready** - don't wait too long
      ...
      },
      {
        ...
        category: "user_guide",
        tags: ["opportunities", "pipeline", "sales"],
        extracted_content: `
...
✓ **Clean up old opps** - close or disqualify stale deals
      ...
      },
      {
        ...
        category: "user_guide",
        tags: ["activities", "tasks", "productivity"],
        extracted_content: `
# Activity Tracking
...
✓ **Review daily** - check your activity list each morning
      ...
      },
      {
        ...
        description: "Business development prospect management",
        category: "user_guide",
        tags: ["bizdev", "sources", "prospects", "bulk-import"],
        extracted_content: `
...
✓ **Use tags** for additional categorization
      ...
      },
      {
        ...
        category: "user_guide",
        tags: ["cashflow", "finance", "expenses"],
        extracted_content: `
...
✓ **Project ahead** - plan for upcoming expenses
      ...
      },
      {
        ...
        description: "AI document extraction and management",
        category: "user_guide",
...
✓ **Act on insights** - don't just collect data
      ...
      },
      {
        ...
        category: "user_guide",
        tags: ["employees", "permissions", "admin"],
        extracted_content: `
# Employee Management
...
✓ **Update promptly** - reflect role changes immediately
      ...
      {
        title: "AI Features",
        description: "AI-powered capabilities and tools",
        category: "user_guide",
...
✓ **Monitor results** - Track AI performance metrics
      ...
      },
      {
        ...
        category: "user_guide",
        tags: ["integrations", "automation", "webhooks"],
        extracted_content: `
...
✓ **Time blocking** - Group similar activities together
      ...
      },
      {
        ...
        description: "Data management and quality tools",
        category: "user_guide",
        tags: ["utilities", "tools", "data-quality"],
        extracted_content: `
...
✓ **Test before production** - Use test data for training
      ...
      },
      {
        ...
        category: "user_guide",
        tags: ["settings", "admin", "configuration"],
        extracted_content: `
...
✓ **Test integrations** - Verify webhook functionality
      ...
      },
      {
        ...
        description: "Best practices and recommended workflows",
        category: "user_guide",
        tags: ["workflow", "process", "best-practices"],
        extracted_content: `
# Workflow Guide
...
✓ **Measure and improve** - Track metrics and adjust processes
    ...
    // Create all documentation records
    const created = await Promise.all(
      documentationContent.map(doc =>
        base44.asServiceRole.entities.DocumentationFile.create({
          ...doc,
          file_name: `${doc.title.toLowerCase().replace(/\s+/g, '-')}.md`,
          file_type: 'md'
        })
      )
    );
    ...
    console.error('Seed documentation error:', error);
    return Response.json({
      success: false,
      error: error.message || 'Failed to seed documentation'
    }, { status: 500 });
  }
});
