...
export default defineConfig({
  ...
  define: {
    ...
    'import.meta.env.VITE_AISHACRM_BACKEND_URL': JSON.stringify(
      process.env.VITE_AISHACRM_BACKEND_URL || '',
    ),
    'import.meta.env.VITE_CALCOM_URL': JSON.stringify(
      process.env.VITE_CALCOM_URL || 'https://scheduler.aishacrm.com',
    ),
    'import.meta.env.VITE_CURRENT_BRANCH': JSON.stringify(
      process.env.VITE_CURRENT_BRANCH || 'main',
    ),
