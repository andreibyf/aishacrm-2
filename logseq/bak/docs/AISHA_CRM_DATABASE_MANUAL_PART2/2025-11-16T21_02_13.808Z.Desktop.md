...
**Endpoints:**
- Single resolve: `GET /api/tenantresolve/:identifier`
- Batch resolve: `GET /api/tenantresolve?ids=a,b,c`
...
4. Monitor cache hit ratio if scaling (instrument with simple counters if needed).
