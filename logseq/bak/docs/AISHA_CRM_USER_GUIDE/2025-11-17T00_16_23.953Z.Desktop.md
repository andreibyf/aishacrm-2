...
- [10.1 Dashboard Reports](#101-dashboard-reports)
- [10.2 Custom Reports](#102-custom-reports)
- [10.3 Exporting Data](#103-exporting-data)
- [10.4 Data Visualization](#104-data-visualization)

### Chapter 11: Workflows and Automation
- [11.1 Understanding Workflows](#111-understanding-workflows)
- [11.2 Creating Workflows](#112-creating-workflows)
- [11.3 Workflow Triggers](#113-workflow-triggers)
- [11.4 Workflow Management](#114-workflow-management)

### Chapter 12: Advanced Features
- [12.1 Document Processing](#121-document-processing)
- [12.2 Email Integration](#122-email-integration)
- [12.3 Business Card Scanner](#123-business-card-scanner)
- [12.4 Duplicate Detection](#124-duplicate-detection)

### Chapter 13: Troubleshooting
- [13.1 Common Issues](#131-common-issues)
- [13.2 Error Messages](#132-error-messages)
