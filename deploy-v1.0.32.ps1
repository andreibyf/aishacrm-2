...
Write-Host "Deploying v1.0.32 to production..." -ForegroundColor Cyan
...
Write-Host "`nDeployment complete! Test login at: https://app.aishacrm.com" -ForegroundColor Green
